...
describe("ModalHolder initialization", () => {
  it("ModalHolder with registered modal id and handler object", async () => {
  ...
  it("ModalHolder with component directly and handler object", async () => {
  ...
  it("ModalHolder with additional props passed through", async () => {
...
describe("Handler.show()", () => {
  it("Handler.show() with args shows modal correctly", async () => {
...
describe("Handler.hide()", () => {
  it("Handler.hide() hides modal correctly", async () => {
...
describe("error handling", () => {
  it("ModalHolder without handler (null) throws error", () => {
    ...
    expect(() => {
      render(
        <Provider>
          <ModalHolder
            modal={modalId}
            handler={null as unknown as ModalHandler}
          />
        </Provider>,
      );
  ...
  it("ModalHolder without handler (undefined) uses default empty object", () => {
  ...
  it("ModalHolder with invalid modal id (not registered) throws error", () => {
  ...
  it("ModalHolder with empty string modal id throws error if not registered", () => {
...
describe("Handler multiple calls", () => {
  it("Handler.show() called multiple times works correctly", async () => {
    // Given: ModalHolder with registered modal and handler
  ...
  it("Handler.hide() called multiple times works correctly", async () => {
    // Given: ModalHolder with registered modal and handler, modal is shown
...
describe("Handler edge cases", () => {
  it("ModalHolder with handler as empty object", () => {
  ...
  it("ModalHolder with handler containing existing properties", () => {
  ...
  it("Handler.show() with null args", async () => {
    // Given: ModalHolder with registered modal and handler
  ...
  it("Handler.show() with undefined args", async () => {
    // Given: ModalHolder with registered modal and handler
  ...
  it("Handler.show() with empty object args", async () => {
    // Given: ModalHolder with registered modal and handler
